...
<body class="text-center">
    <header>
        <h3>Listing Siswa Kelas Privat</h3>
    </header>
    ...
    <table class="table table-striped table-bordered table-hover">
        ...
        <tbody>
            ...
            <?php
            $sql = "SELECT * FROM privat, user, db_kursus_privat WHERE privat.user_id = user.id";
            ...
            while ($siswa = mysqli_fetch_array($query)) {
                ...
                echo "<td>" . $siswa['tarif_privat'] . "</td>";
                echo "<td>" . $siswa['name_kursus'] . "</td>";
