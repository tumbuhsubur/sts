...
<head>
  ...
  <nav class="navbar navbar-light navbar-expand bg-white text-center shadow d-inline-flex justify-content-xl-center align-items-xl-center mb-4 topbar static-top" style="width: 1280px;height: 100px;background: var(--blue);">
    <div class="container-fluid"><button class="btn btn-link d-md-none rounded-circle mr-3" id="sidebarToggleTop" type="button"><i class="fas fa-bars"></i></button><img class="img-fluid" src="assets/img/logo%20sts%20transparan.png" style="height: 80px;" href="beranda.html">
      ...
      <a class="btn btn-primary active btn-block text-white btn-user" role="button" style="width: 100px;margin-left: 10px;margin-right: 10px;" href="login.php">Login</a>
    </div>
  </nav>
</head>
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form class="user" name="login-user" action="proses-login.php" method="POST">
                    <div class="form-group"><input class="form-control form-control-user" type="email" id="email" aria-describedby="emailHelp" placeholder="Masukkan email anda" name="email"></div>
                    <div class="form-group"><input class="form-control form-control-user" type="password" id="password" placeholder="Masukkan password anda" name="password"></div>
                    ...
                    </div><button class="btn btn-primary btn-block text-white btn-user" name="Submit" value="Login" type="submit">Login</button>
                    <hr>
                    <hr>
                  </form>
