...
<body class="text-center">
    <header>
        <h3>Formulir Pendaftaran Siswa Baru Sanggar Tari Sangkuriang</h3>
    </header>
    ...
    <form action="proses-pendaftaran.php" method="POST">
        ...
        <fieldset>
            ...
            <p>
                ...
                <textarea name="email" placeholder="username@domain.com"></textarea>
            </p>
            <p>
                <label for="image">Foto: </label>
                <textarea name="image" value="image.jpg"></textarea>
            </p>
            <p>
                <label for="password">Password: </label>
                <textarea name="password" value="123"></textarea>
            </p>
            <p>
                <label for="role_id">Role: </label>
                <textarea type="int" name="role_id" value="1"></textarea>
            </p>
            <p>
                <label for="is_active">Aktif: </label>
                <textarea type="int" name="is_active" value="1"></textarea>
            </p>
            <p>
                <label for="date_created">Tanggal Daftar: </label>
                <textarea type="datetime" name="date_created" value="current_timestamp()"></textarea>
            </p>
            <p>
