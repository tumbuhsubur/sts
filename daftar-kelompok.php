...
$sql = "SELECT * FROM user LEFT JOIN privat ON user.id=privat.user_id WHERE user.id=$id";
...
<head>
    <title>Formulir Daftar Private</title>
</head>
...
<body>
    ...
    <form action="proses-private.php" method="POST">
